...
function um_submit_form_errors_hook_login( $args ) {
	...
	if ( isset( $args['username'] ) && $args['username'] == '' ) {
		UM()->form()->add_error( 'username', __( 'Por favor ingrese su usuario o correo electrónico', 'ultimate-member' ) );
	}
	...
	if ( $args['user_password'] == '' ) {
		UM()->form()->add_error( 'user_password', __( 'Por favor ingrese la contraseña', 'ultimate-member' ) );
	}
	...
	if ( $user && wp_check_password( $args['user_password'], $user->data->user_pass, $user->ID ) ) {
		...
		UM()->form()->add_error( 'user_password', __( 'La conrtraseña es incorrecta, por favor intente de nuevo', 'ultimate-member' ) );
	}
