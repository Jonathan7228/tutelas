	...
	UM()->admin_forms( array(
		...
		'fields' => array(
			...
			array(
				...
				'placeholder'	=> __( 'Por favor acepte los términos y condiciones', 'ultimate-member' ),
				'value'		    => UM()->query()->get_meta_value('_um_register_use_gdpr_error_text', null, __( 'Por favor acepte los términos y condiciones', 'ultimate-member' ) ),
				'conditional' 	=> array( '_um_register_use_gdpr', '=', '1' )
			)
		)
	) )->render_form(); ?>
